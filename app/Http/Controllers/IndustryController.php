...
{
    /**
     * Supported industry configurations for SEO and programmatic landing pages.
     *
    ...
    protected array $industries = [
        'plumbing-answering-service' => [
            ...
            'heroSubtitle' => 'Never miss a $1,500 burst pipe or water heater emergency call again. Our voice AI answers instantly, triages main line clogs, and books jobs directly to your schedule with travel buffer protection.',
            'metaTitle' => 'AI Answering Service & Dispatch for Plumbers | JustMascot',
            'metaDescription' => '24/7 AI voice phone receptionist for plumbing contractors. Qualify burst pipes, water heaters, and drain clogs with automated dispatch and zero hold time.',
            'keywords' => [
                'plumbing answering service',
            ...
            'painPoints' => [
                [
                    ...
                    'description' => 'When homeowners have water pouring through ceilings at 2 AM, they call down Google listings until someone answers. If you miss the call, a competitor gets the $2,000 job.',
                ],
                [
                    'title' => 'Burnout from Night-Shift On-Call Rotations',
                    'description' => 'Your master plumbers hate waking up for non-urgent dripping faucets. JustMascot AI triages true emergencies from routine maintenance inquiries automatically.',
                ],
                [
                    'title' => 'Clustered Bookings Without Travel Time',
                    'description' => 'Human call centers double-book plumbers across opposite sides of town. Our AI calculates route drive times and buffers 90 minutes between job dispatches.',
                ],
            ],
            'keyFeatures' => [
                [
                    'title' => 'Emergency Shutoff Guidance',
                    'description' => 'Voice AI calmly instructs callers on isolating their main water valve while simultaneously dispatching your on-call technician.',
                ],
                [
                    'title' => 'EPA & Master License Skill Routing',
                    'description' => 'Matches gas line replacements, backflow certifications, and sewer camera scopes strictly to qualified technicians.',
                ],
                [
                    'title' => 'Instant SMS & Calendar Sync',
                    'description' => 'Sends address, gate codes, customer recordings, and diagnostic notes straight to technician mobile apps.',
                ],
            ],
            'faqs' => [
                [
        ...
        'hvac-ai-receptionist' => [
            ...
            'heroSubtitle' => 'Capture every peak summer AC breakdown and winter furnace outage. Our voice AI verifies EPA 608 certifications, quotes standard diagnostic fees, and locks in appointments in real time.',
            'metaTitle' => 'AI Answering Service & Dispatch for HVAC Contractors | JustMascot',
            'metaDescription' => 'Autonomous voice receptionist for HVAC businesses. Qualify AC repairs, compressor diagnostic fees, and heat pump failures with sub-second AI voice response.',
            'keywords' => [
            ...
            'painPoints' => [
                [
                    ...
                    'description' => 'When temperatures hit 100°F, call volume spikes 500%. Traditional receptionists drop calls, leaving frantic customers to hire the next HVAC contractor.',
                ],
                [
                    'title' => 'Wrong Technician Dispatched for Specialty Units',
                    'description' => 'Sending a junior installer to a complex VRF or commercial heat pump diagnostic wastes valuable truck rolls and billable hours.',
                ],
                [
                    'title' => 'Uncollected Diagnostic Fees',
                    'description' => 'AI communicates standard trip/diagnostic fees upfront, setting clear expectations before your technician rolls out.',
                ],
            ],
            'keyFeatures' => [
                [
                    'title' => 'Automated Diagnostic Fee Authorization',
                    'description' => 'Explains dispatch pricing, collects customer agreement, and eliminates billing pushback on arrival.',
                ],
                [
                    'title' => 'Refrigerant & System Triage',
                    'description' => 'Gathers equipment make, tonnage, error codes, and age before scheduling to prepare your technician with the right parts.',
                ],
                [
                    'title' => 'Smart On-Call Rotation Management',
                    'description' => 'Respects technician shift limits and prevents dispatching exhausted crew members beyond maximum allowable hours.',
                ],
            ],
            'faqs' => [
                [
        ...
        'electrical-contractor-dispatch' => [
            ...
            'heroSubtitle' => 'Isolate sparking panels, commercial power loss, and EV charger installs. Voice AI qualifies voltage requirements, matches Master Electrician certifications, and books high-ticket jobs 24/7.',
            'metaTitle' => 'AI Answering Service for Electricians | JustMascot',
            'metaDescription' => 'AI voice dispatch and receptionist for electrical contractors. Triage breaker trips, panel upgrades, and commercial electrical emergencies with zero missed calls.',
            'keywords' => [
            ...
            'painPoints' => [
                [
                    ...
                    'description' => 'Generic call centers do not understand electrical fire hazards. Our AI prioritizes urgent safety guidance immediately.',
                ],
                [
                    'title' => 'High-Value Panel Upgrade Leads Slipping Away',
                    'description' => 'EV charger installations and 200A main panel upgrade inquiries often call during evening hours and choose whoever replies first.',
                ],
                [
                    'title' => 'Journeyman vs Master Electrician Misassignment',
                    'description' => 'Ensure permitted commercial work and service changes are only scheduled with properly licensed team members.',
                ],
            ],
            'keyFeatures' => [
                [
                    'title' => 'Safety Protocol Instruction',
                    'description' => 'Advises callers to avoid touching sparked receptacles and shut off subpanels when safe while dispatching emergency crew.',
                ],
                [
                    'title' => 'Residential vs Commercial Triage',
                    'description' => 'Distinguishes between 3-phase industrial power faults and residential breaker resets seamlessly.',
                ],
                [
                    'title' => 'Route Distance & Drive Time Guard',
                    'description' => 'Enforces 1.5-hour travel buffers between job sites to ensure electrical crews arrive on time with complete truck kits.',
                ],
            ],
            'faqs' => [
                [
        ...
        'roofing-emergency-call-handling' => [
            ...
            'heroSubtitle' => 'When severe storms strike, capture hundreds of urgent roof tarping, leak repair, and insurance claim inspection calls without putting a single homeowner on hold.',
            'metaTitle' => 'AI Answering Service for Roofing Contractors | JustMascot',
            'metaDescription' => 'Storm surge AI voice dispatcher for roofing companies. Handle 100+ simultaneous storm damage and emergency tarping calls with instant calendar booking.',
            'keywords' => [
            ...
            'painPoints' => [
                [
                    ...
                    'description' => 'Hailstorms and hurricanes generate 200+ calls in 3 hours. Standard front desks collapse, leaving thousands in reroofing revenue on the table.',
                ],
                [
                    'title' => 'Missing Insurance Claim Windows',
                    'description' => 'Homeowners file insurance claims quickly with the first contractor who schedules an on-site adjuster inspection.',
                ],
                [
                    'title' => 'Wasted Fuel on Out-of-Territory Leads',
                    'description' => 'AI checks zip codes against your precise service radius before confirming appointments.',
                ],
            ],
            'keyFeatures' => [
                [
                    'title' => 'High-Volume Storm Concurrency',
                    'description' => 'Answer hundreds of callers simultaneously during severe weather events with zero busy tones.',
                ],
                [
                    'title' => 'Insurance Claim & Tarping Triage',
                    'description' => 'Categorizes active interior water leaks for immediate emergency tarping vs post-storm shingle inspections.',
                ],
                [
                    'title' => 'Zip-Code & Radius Filtering',
                    'description' => 'Ensures only qualified homeowners within your licensed county or territory are booked.',
                ],
            ],
            'faqs' => [
                [
        ...
        'appliance-repair-scheduling' => [
            ...
            'heroSubtitle' => 'Book refrigerator, washer, dryer, and oven repairs while you are in the field. Our voice AI captures model numbers, error codes, and authorizes diagnostic call-out fees automatically.',
            'metaTitle' => 'AI Answering Service for Appliance Repair | JustMascot',
            'metaDescription' => '24/7 AI receptionist for appliance repair businesses. Collect brand/model information, quote trip fees, and schedule repairs without answering the phone.',
            'keywords' => [
            ...
            'painPoints' => [
                [
                    ...
                    'description' => 'You cannot answer customer calls while diagnosing sealed refrigeration systems. Every unanswered call is a lost $250 repair job.',
                ],
                [
                    'title' => 'Arriving Without Part Model Numbers',
                    'description' => 'Without knowing whether the unit is Sub-Zero, Bosch, or Samsung, technicians waste trips returning to parts suppliers.',
                ],
                [
                    'title' => 'Customers Shocked by Service Call Fees',
                    'description' => 'AI clearly explains trip and diagnostic fee structures so customers agree before scheduling.',
                ],
            ],
            'keyFeatures' => [
                [
                    'title' => 'Model & Symptom Intake',
                    'description' => 'Prompts callers for appliance brand, approximate age, and specific symptoms (not cooling, error code E15, loud spin cycle).',
                ],
                [
                    'title' => 'Brand Certification Routing',
                    'description' => 'Routes high-end luxury appliances (Sub-Zero, Wolf, Viking) only to certified factory-trained technicians.',
                ],
                [
                    'title' => 'Calendar & Travel Buffer Scheduling',
                    'description' => 'Clusters daily jobs geographically to minimize drive time between diagnostic calls.',
                ],
            ],
            'faqs' => [
                [
        ...
        'pest-control-answering-service' => [
            ...
            'heroSubtitle' => 'Book termite inspections, emergency rodent exclusions, and recurring perimeter spray plans on autopilot. Voice AI qualifies pest types and locks in routes effortlessly.',
            'metaTitle' => 'AI Answering Service for Pest Control | JustMascot',
            'metaDescription' => 'Automated AI voice receptionist for pest control businesses. Triage termites, bed bugs, and rodent emergencies with instant scheduling.',
            'keywords' => [
                'pest control answering service',
            ...
            'painPoints' => [
                [
                    ...
                    'description' => 'Homeowners seeing bed bugs or rodents will call down the list until they speak to someone who schedules an immediate inspection.',
                ],
                [
                    'title' => 'Wasted Time on Out-of-Scope Wildlife',
                    'description' => 'If you do not handle raccoons or venomous snakes, the AI politely clarifies service boundaries and refers callers elsewhere.',
                ],
                [
                    'title' => 'Missed Recurring Subscription Opportunities',
                    'description' => 'AI introduces seasonal perimeter maintenance plans during the initial inquiry to maximize customer lifetime value.',
                ],
            ],
            'keyFeatures' => [
                [
                    'title' => 'Pest Species Triage',
                    'description' => 'Identifies termites, carpenter ants, German roaches, rodents, and wasps to assign the right chemical rigs.',
                ],
                [
                    'title' => 'Square Footage & Property Qualification',
                    'description' => 'Captures lot size, foundation type (slab vs crawlspace), and pet safety considerations.',
                ],
                [
                    'title' => 'Route Density Optimization',
                    'description' => 'Groups neighboring pest control service stops on dedicated zone days.',
                ],
            ],
            'faqs' => [
                [
        ...
        'garage-door-emergency-dispatch' => [
            ...
            'heroSubtitle' => 'Capture every trapped car emergency and snapped torsion spring call. Voice AI qualifies door dimensions, spring types, and dispatches on-call technicians immediately.',
            'metaTitle' => 'AI Answering Service for Garage Door Contractors | JustMascot',
            'metaDescription' => '24/7 emergency voice AI receptionist for garage door repair businesses. Fast triage for broken springs, off-track doors, and stuck openers.',
            'keywords' => [
            ...
            'painPoints' => [
                [
                    ...
                    'description' => 'When a spring snaps at 6:30 AM before work, callers book the very first company that answers their call.',
                ],
                [
                    'title' => 'High Weekend & Evening Emergency Volume',
                    'description' => 'Overhead doors break at random times. Missing evening calls means losing profitable emergency fee premiums.',
                ],
                [
                    'title' => 'Commercial Roll-up vs Residential Confusion',
                    'description' => 'AI distinguishes standard residential sectional doors from commercial high-lift roll-up doors before dispatch.',
                ],
            ],
            'keyFeatures' => [
                [
                    'title' => 'Emergency Urgency Tagging',
                    'description' => 'Flags trapped vehicles inside garages as top-priority dispatches to your on-call mobile technician.',
                ],
                [
                    'title' => 'Safety Warning Protocol',
                    'description' => 'Warns callers not to pull emergency release cords on snapped cables to prevent heavy door collapse injuries.',
                ],
                [
                    'title' => 'Standard Spring & Opener Quoting',
                    'description' => 'Quotes diagnostic and baseline single vs double spring replacement ranges according to your pricing table.',
                ],
            ],
            'faqs' => [
                [
        ...
        'locksmith-call-answering' => [
            ...
            'heroSubtitle' => 'Never lose a locked-out customer to competitor dispatchers. Voice AI gathers address coordinates, vehicle/door lock specs, and dispatches the nearest mobile technician in seconds.',
            'metaTitle' => 'AI Answering Service for Locksmiths | JustMascot',
            'metaDescription' => '24/7 voice AI receptionist for locksmith companies. Instant qualification for automotive lockouts, rekeying, and commercial access hardware.',
            'keywords' => [
            ...
            'painPoints' => [
                [
                    ...
                    'description' => 'A stranded customer standing outside in the rain will not leave a voicemail. They dial the next listing within 15 seconds.',
                ],
                [
                    'title' => 'Scam Impressions & Trust Issues',
                    'description' => 'AI delivers a polished, professional, branded greeting with transparent pricing that builds instant customer trust.',
                ],
                [
                    'title' => 'Incomplete Automotive Key Details',
                    'description' => 'AI collects vehicle year, make, model, and push-to-start smart key specs so technicians bring the correct programmer.',
                ],
            ],
            'keyFeatures' => [
                [
                    'title' => 'Precise Location & Cross-Street Capture',
                    'description' => 'Captures exact parking lot or residential location details for accurate mobile navigation.',
                ],
                [
                    'title' => 'Key Programming vs Rekey Triage',
                    'description' => 'Categorizes transponder keys, high-security deadbolts, and master key system requests accurately.',
                ],
                [
                    'title' => 'ID Verification Notice',
                    'description' => 'Reminds callers that valid government ID and proof of ownership are required on technician arrival.',
                ],
            ],
            'faqs' => [
                [
    ...
    /**
     * Show an industry-specific vertical landing page.
     */
    ...
    /**
     * Show the interactive Missed Call Revenue Loss Calculator tool.
     */
    ...
    /**
     * Get all supported industry slugs (helper for sitemap and tests).
     *
     * @return array<string>
     */
    public function getIndustrySlugs(): array
    {
