    ...
    >
        ...
        >
            <div class="flex items-center gap-4">
                <div
                    class="rounded-2xl border-4 border-slate-900 bg-[#3B82F6] p-3 text-white dark:border-slate-100"
                >
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div class="flex flex-col gap-6 lg:col-span-1">
                ...
                >
                    ...
                    <div
                        class="dark:bg-slate-850 relative mb-4 flex h-60 w-60 items-center justify-center rounded-2xl border-4 border-slate-900 bg-slate-50 dark:border-slate-100"
                    >
            ...
            <div class="flex flex-col gap-6 lg:col-span-2">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                    ...
                    >
                        <div class="flex items-center justify-between">
                            <span
                                class="text-xs font-black text-slate-400 uppercase"
                                >Avg Call Quality</span
                            >
                            <Smile class="h-5 w-5 text-emerald-500" />
                        </div>
                        <p class="mt-2 text-3xl font-black">
                            {{ formatCqs(averageCqs) }}
                        </p>
                    </div>
                ...
                >
                    ...
                    <div class="space-y-4">
                        <div
                            class="flex items-center justify-between rounded-xl border-2 border-slate-900 bg-slate-50 p-4 dark:border-slate-100 dark:bg-slate-800"
                        >
                            <div>
                                <h4 class="font-black">
                                    Weekly Booking Target (>= 8)
                                </h4>
                                <p
                                    class="text-xs text-slate-500 dark:text-slate-400"
                                >
                                    Assures healthy booking acquisition metrics.
                                </p>
                            </div>
                            <span
                                class="rounded-lg px-3 py-1 text-xs font-black text-white uppercase"
                                :class="
                                    weeklyPerformanceTargetMet
                                        ? 'bg-emerald-500'
                                        : 'bg-amber-500'
                                "
                            >
                        ...
                        >
                            <div>
                                <h4 class="font-black">
                                    Average Call Quality Score Threshold (>=
                                    85%)
                                </h4>
                                <p
                                    class="text-xs text-slate-500 dark:text-slate-400"
                                >
                                    Monitors dispatcher customer satisfaction
                                    levels.
                                </p>
                            </div>
                            <span
                        ...
                        >
                            <div>
                                <h4 class="font-black">
                                    Conversational Latency Drift (<= 300ms)
                                </h4>
                                <p
                                    class="text-xs text-slate-500 dark:text-slate-400"
                                >
                                    Tracks delays in AI agent text-to-speech
                                    loops.
                                </p>
                            </div>
                            <span
