    ...
    >
        ...
        >
            <div class="flex items-center gap-4">
                <div
                    class="rounded-2xl border-4 border-slate-900 bg-indigo-500 p-3 text-white dark:border-slate-100"
                >
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div class="flex flex-col gap-6 lg:col-span-1">
                ...
                >
                    ...
                    <div
                        class="relative mx-auto my-6 flex h-48 w-48 items-center justify-center rounded-full border-8 border-slate-900 bg-slate-50 dark:border-slate-100 dark:bg-slate-800"
                    >
                ...
                >
                    ...
                    <div
                        class="relative mx-auto flex h-48 w-48 items-center justify-center rounded-2xl border-4 border-slate-900 bg-slate-50 dark:border-slate-100 dark:bg-slate-800"
                    >
            ...
            <div class="flex flex-col gap-6 lg:col-span-2">
                ...
                >
                    <h3
                        class="mb-6 text-xs font-black tracking-widest text-slate-500 uppercase dark:text-slate-400"
                    >
                    ...
                    <div class="space-y-4">
                        <div
                            ...
                            :key="index"
                            class="flex flex-col gap-4 rounded-2xl border-4 border-slate-900 bg-slate-50 p-5 md:flex-row md:items-center md:justify-between dark:border-slate-100 dark:bg-slate-800"
                        >
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p
                                        class="mt-0.5 text-xs font-bold text-slate-500 dark:text-slate-400"
                                    >
                                        {{ audit.details }}
                                    </p>
                                </div>
                            ...
                            <div>
                                <span
                                    class="inline-block rounded-xl border-2 border-slate-900 px-3 py-1 text-xs font-black text-white uppercase dark:border-slate-100"
                                    :class="[
                                        audit.status
                                            ? 'bg-emerald-500'
                                            : 'bg-rose-500',
